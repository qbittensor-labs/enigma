...
class JWTManager:
    ...
    def __init__(self, keypair: bt.Keypair, netuid: int) -> None:
        ...
        self._tensorauth_url: str = os.environ.get("TENSORAUTH_URL", "https://tensorauth.qbittensorlabs.com")

    def get_jwt(self) -> JWT:
        """Fetch JWT from tensorauth service using signed header"""
        bt.logging.trace(f" ☎️  Contacting tensorauth service for a JWT. My hotkey is {self._keypair.ss58_address}")
